...
/// A row you get from running the `door` query
/// defined in `./src/lore/world/sql/door.sql`.
///
/// > 🐿️ This type definition was generated automatically using v4.4.1 of the
/// > [squirrel package](https://github.com/giacomocavalieri/squirrel).
///
pub type DoorRow {
  DoorRow(door_id: Int, access_state: AccessState)
}
...
/// A row you get from running the `exits_by_room_id` query
/// defined in `./src/lore/world/sql/exits_by_room_id.sql`.
///
/// > 🐿️ This type definition was generated automatically using v4.4.1 of the
/// > [squirrel package](https://github.com/giacomocavalieri/squirrel).
///
pub type ExitsByRoomIdRow {
  ExitsByRoomIdRow(
    exit_id: Int,
    keyword: String,
    from_room_id: Int,
...
/// Runs the `exits_by_room_id` query
/// defined in `./src/lore/world/sql/exits_by_room_id.sql`.
///
/// > 🐿️ This function was generated automatically using v4.4.1 of
/// > the [squirrel package](https://github.com/giacomocavalieri/squirrel).
///
pub fn exits_by_room_id(
  db: pog.Connection,
  arg_1: Int,
) -> Result(pog.Returned(ExitsByRoomIdRow), pog.QueryError) {
  let decoder = {
    ...
    decode.success(ExitsByRoomIdRow(
      exit_id:,
      keyword:,
      from_room_id:,
      to_room_id:,
